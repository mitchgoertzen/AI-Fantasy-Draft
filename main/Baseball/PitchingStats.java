...
public class PitchingStats {
    ...
    public void addPitchingStats(String[] array, int year){
        ...
        // System.out.println();
        stats[3] = wins += Float.parseFloat(array[3]) / ((year * 2) + 1);
        stats[4] = losses += Float.parseFloat(array[4]) / ((year * 2) + 1);
        stats[5] = completeGames += Float.parseFloat(array[8]) / ((year * 2) + 1);
        stats[6] = shutouts += Float.parseFloat(array[9]) / ((year * 2) + 1);
        stats[7] = saves += Float.parseFloat(array[10]) / ((year * 2) + 1);
        stats[8] = outs = (3 * (int)IP) + /* IP(no decimal) * 3 + decimal / */  year;
        stats[9] = hits += Float.parseFloat(array[12]) / ((year * 2) + 1);
        stats[10] = totalBattersFaced += Float.parseFloat(array[22]) / ((year * 2) + 1);
        stats[11] = runs += Float.parseFloat(array[13]) / ((year * 2) + 1);
        stats[12] = earnedRuns += Float.parseFloat(array[14]) / ((year * 2) + 1);
        stats[13] = homeRuns += Float.parseFloat(array[15]) / ((year * 2) + 1);
        stats[14] = walks += Float.parseFloat(array[16]) / ((year * 2) + 1);
        stats[15] = intentionalWalks += Float.parseFloat(array[17]) / ((year * 2) + 1);
        stats[16] = hitBatters += Float.parseFloat(array[19]) / ((year * 2) + 1);
        stats[17] = strikeouts += Float.parseFloat(array[18]) / ((year * 2) + 1);
        stats[18] = wildPitches += Float.parseFloat(array[21]) / ((year * 2) + 1);
        stats[19] = balks += Float.parseFloat(array[20]) / ((year * 2) + 1);
        //stats[20] = stolenBasesAllowed += Float.parseFloat(array[0]) / ((year * 2) + 1);
        //stats[21] = GIDP += Float.parseFloat(array[0]) / ((year * 2) + 1);
        //stats[22] = saveChances += Float.parseFloat(array[0]) / ((year * 2) + 1);
        //stats[23] = holds += Float.parseFloat(array[0]) / ((year * 2) + 1);
        //stats[24] = totalBasesAllowed += Float.parseFloat(array[0]) / ((year * 2) + 1);
        ...
        //stats[29] = pitchCount += Float.parseFloat(array[0]) / ((year * 2) + 1);
        //stats[30] = singlesAllowed += Float.parseFloat(array[0]) / ((year * 2) + 1);
        //stats[31] = doublesAllowed += Float.parseFloat(array[0]) / ((year * 2) + 1);
        //stats[32] = triplesAllowed += Float.parseFloat(array[0]) / ((year * 2) + 1);
        //stats[33] = reliefWins += Float.parseFloat(array[0]) / ((year * 2) + 1);
        //stats[34] = reliefLosses += Float.parseFloat(array[0]) / ((year * 2) + 1);
        //stats[35] = pickoffs += Float.parseFloat(array[0]) / ((year * 2) + 1);
        //stats[36] = reliefAppearances += Float.parseFloat(array[0]) / ((year * 2) + 1);
        //stats[37] = OBP += Float.parseFloat(array[0]) / ((year * 2) + 1);
        ...
        //stats[41] = noHitters += Float.parseFloat(array[0]) / ((year * 2) + 1);
        //stats[42] = perfectGames += Float.parseFloat(array[0]) / ((year * 2) + 1);
        //stats[43] = savePercentage += Float.parseFloat(array[0]) / ((year * 2) + 1);
        //stats[44] = inheritedRunnersScored += Float.parseFloat(array[0]) / ((year * 2) + 1);
        //stats[45] = qualityStarts += Float.parseFloat(array[0]) / ((year * 2) + 1);
        //stats[46] = blownSaves += Float.parseFloat(array[0]) / ((year * 2) + 1);
        //stats[47] = netSaves += Float.parseFloat(array[0]) / ((year * 2) + 1);
        //stats[48] = savesPlusHolds += Float.parseFloat(array[0]) / ((year * 2) + 1);
        //stats[49] = netSavesandHolds += Float.parseFloat(array[0]) / ((year * 2) + 1);
        //stats[50] = netWins += Float.parseFloat(array[0]) / ((year * 2) + 1);
    ...
    private float calculateInnings(float currentInnings, int year){
        ...
        int currentAdjustedFullInnings = (int) currentInnings / ((year * 2) + 1);
